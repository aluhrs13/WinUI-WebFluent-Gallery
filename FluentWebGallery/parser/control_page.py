...
ELEMENT_MAPPING = {
    ...
    'DatePicker': {'new_tag': 'ProxyDatePicker', 'attributes': {'class': ''}},
    'AppBarToggleButton': {'new_tag': 'ProxyAppBarToggleButton', 'attributes': {'class': 'TODO'}},
    'AppBarSeparator': {'new_tag': 'ProxyToolbarDivider', 'attributes': {'class': ''}},
    'AutoSuggestBox': {'new_tag': 'ProxySearchBox', 'attributes': {'class': ''}},
    'BreadcrumbBar': {'new_tag': 'ProxyBreadcrumb', 'attributes': {'class': ''}},
    'BreadcrumbBarItem': {'new_tag': 'ProxyBreadcrumbItem', 'attributes': {'class': ''}},
    'CalendarView': {'new_tag': 'ProxyCalendar', 'attributes': {'class': ''}},
    'ComboBoxItem': {'new_tag': 'ProxyOption', 'attributes': {'class': ''}},
    'DatePicker': {'new_tag': 'ProxyDatePicker', 'attributes': {'class': ''}},
    'DropDownButton': {'new_tag': 'ProxyDropDownButton', 'attributes': {'class': ''}},
    'Hyperlink': {'new_tag': 'a', 'attributes': {'class': ''}},
    'HyperlinkButton': {'new_tag': 'ProxyButton', 'attributes': {'class': ''}},
    ...
    'ControlExample.CSharp': {'new_tag': 'div', 'attributes': {'class': 'CSharp'}},
    ...
    'Double': {'new_tag': 'div', 'attributes': {'class': 'hidden'}},

    # Icons
    'BitmapIcon': {'new_tag': 'ProxyIcon', 'attributes': {'class': ''}},
    'BitmapIconSource': {'new_tag': 'ProxyIcon', 'attributes': {'class': ''}},
    'AppBarToggleButton.Icon': {'new_tag': 'ProxyIcon', 'attributes': {'slot': 'icon'}},
    'AppBarButton.Icon': {'new_tag': 'ProxyIcon', 'attributes': {'slot': 'icon'}},
    'FontIcon': {'new_tag': 'div', 'attributes': {'class': ''}},
    'FontIconSource': {'new_tag': 'div', 'attributes': {'class': ''}},

    # Content
    'AppBarToggleButton.Content': {'new_tag': 'span', 'attributes': {'class': ''}},
    'AppBarButton.Content': {'new_tag': 'span', 'attributes': {'class': ''}},
    'Button.Content': {'new_tag': 'span', 'attributes': {'class': ''}},
    'DropDownButton.Content': {'new_tag': 'span', 'attributes': {'class': ''}},

    # TODO: Actual Components


    # TODO: Flyouts
    'Button.Flyout': {'new_tag': 'ProxyPopoverSurface', 'attributes': {'class': ''}},
    'DropDownButton.Flyout': {'new_tag': 'ProxyPopoverSurface', 'attributes': {'class': ''}},
    'Flyout': {'new_tag': 'ProxyPopoverSurface', 'attributes': {'class': ''}},
    ...
    # TODO: Figure out Grid Definitions
    ...
    # TODO: Layouts
    'Grid': {'new_tag': 'LayoutGrid', 'attributes': {'class': ''}},
    'GridView': {'new_tag': 'LayoutGridView', 'attributes': {'class': ''}},
    ...
    'Frame': {'new_tag': 'div', 'attributes': {'class': 'Frame'}},
