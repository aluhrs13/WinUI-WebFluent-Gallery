...
<NavCategory value="AccessibilityItem">
    ...
    <NavSubItemGroup>
        <NavSubItem value="AccessibilityColorContrast">Color Contrast</NavSubItem>
        <NavSubItem value="AccessibilityKeyboard">Keyboard Support</NavSubItem>
        <NavSubItem value="AccessibilityScreenReader">Screen Reader Support</NavSubItem>
    </NavSubItemGroup>
</NavCategory>
...
<NavCategory value="Scrolling">
    ...
    <NavSubItemGroup>
        <NavSubItem value="AnnotatedScrollBar">AnnotatedScrollBar</NavSubItem>
...
<NavCategory value="Layout">
    ...
    <NavSubItemGroup>
        ...
        <NavSubItem value="VariableSizedWrapGrid">VariableSizedWrapGrid</NavSubItem>
...
<NavCategory value="Media">
    ...
    <NavSubItemGroup>
        <NavSubItem value="AnimatedVisualPlayer">AnimatedVisualPlayer</NavSubItem>
        <NavSubItem value="CaptureElementPreview">Capture Element / Camera Preview</NavSubItem>
        <NavSubItem value="Image">Image</NavSubItem>
        <NavSubItem value="MapControl">MapControl</NavSubItem>
        <NavSubItem value="MediaPlayerElement">MediaPlayerElement</NavSubItem>
...
<NavCategory value="Styles">
    ...
    <NavSubItemGroup>
        ...
        <NavSubItem value="ColorPaletteResources">ColorPaletteResources</NavSubItem>
        <NavSubItem value="CompactSizing">Compact Sizing</NavSubItem>
        <NavSubItem value="IconElement">IconElement</NavSubItem>
        <NavSubItem value="RadialGradientBrush">RadialGradientBrush</NavSubItem>
        ...
        <NavSubItem value="SystemBackdrops">System Backdrops (Mica/Acrylic)</NavSubItem>
    </NavSubItemGroup>
</NavCategory>
...
<NavCategory value="Motion">
    ...
    <NavSubItemGroup>
        <NavSubItem value="ConnectedAnimation">Connected Animation</NavSubItem>
        ...
        <NavSubItem value="ImplicitTransition">Implicit Transitions</NavSubItem>
...
<NavCategory value="MultipleWindows">
    ...
    <NavSubItemGroup>
        <NavSubItem value="CreateMultipleWindows">Multiple windows</NavSubItem>
